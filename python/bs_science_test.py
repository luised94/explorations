...
### Add more journals
###
###Science is protected by cloud. Fuck me I guess.

from bs4 import BeautifulSoup
import requests
import cloudscraper

url = "https://www.science.org/doi/10.1126/science.abq7641"
...
article_title = str(soup.find("h1")).replace(" ", "_")
print(soup.body.contents)
print(soup.find_all("a"))
print(soup.find_all("href"))
print(str(soup.find(class_="name")).replace(" ", "_"))
