...
cur.execute(
    'INSERT INTO items (itemType, dateAdded, dateModified) VALUES ("url", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)'
)
item_id = cur.lastrowid
cur.execute(
    "INSERT INTO itemData (itemID, fieldID, value) VALUES (?, ?, ?)",
    (item_id, 110, url),
)
cur.execute(
    "INSERT INTO itemAttachments (itemID, parentItemID, linkMode, contentType, path, storageModTime) VALUES (?, ?, ?, ?, ?, ?)",
    (item_id, None, "imported_url", "text/x-url", "", None),
)
