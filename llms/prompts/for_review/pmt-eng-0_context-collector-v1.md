...
<task_and_context>
<!-- CONFIGURABLE: Replace this block per use. Define the task, project, or question
     that determines what counts as relevant. The more specific the anchor,
     the tighter the extraction. -->

TASK: [What you are working on or continuing]

CONTEXT: [Project background, current phase, specific questions, constraints.
          Include enough detail that relevance judgments are unambiguous.]

FOCUS: [Optional. Narrow the extraction further: specific subsystems, decisions,
        technical domains, or time periods to prioritize.]
</task_and_context>
...
The user provides one or more conversation transcripts, documents, or text fragments after this prompt. Treat all provided material as source material for extraction.
