...
format:
  pdf:
    include-in-header:
      text: |
        \usepackage[normalem]{ulem} % For custom underlining
...
Use of genetic and biochemical assays to understand the function of ATP hydrolysis by the origin-recognition complex during \textit{Saccharomyces cerevisiae} DNA replication.
  - Design and validation of a genetic screen for suppressors of a lethal allele of the _ORC4_ gene. Performed the analysis of the whole-genome sequencing data
