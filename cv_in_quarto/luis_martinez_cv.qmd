...
\begin{center}
Protein Purification | Genetic screens | Chromatin Immunoprecipitation Analysis
\end{center}
\vspace{-1.3em}
Ph.D. with 9+ years of expertise across protein and nucleic-acid biochemistry, molecular biology, and yeast genetics, specializating in DNA replication mechanisms, advanced biochemical/genetic screen assay development, and bioinformatic analysis.
