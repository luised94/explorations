...
Trying some modifications to the cvsection. Color version is terrible. Maybe bracket one is salvageable.
```latex
        \definecolor{cvblue}{RGB}{0,102,153}  % Professional blue
        \newcommand{\cvsectioncolor}[1]{%
          \vspace{-1.5em}
          \section*{\fontsize{11}{13}\selectfont\textcolor{cvblue}{\textbf{#1}}}%
          \noindent\textcolor{cvblue}{\rule{0.3\linewidth}{0.8pt}}
          \vspace{-1.3em}
        }
...
## 2025-06-12
Trying to get feedback on styles and content.
Best to leave summary but it has to be high in affordance and impact.
Considering adding some aesthetic improvements to cvsection
Added post-doc experience
