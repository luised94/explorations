...
#
#   argv 컴parse컴? command name + args        (pure)
#   files 컴load_store컴? Store                (IO, edge)
#   (Store, args, Clock) 컴transform_*컴? Effects   (pure: ALL logic)
#   Effects 컴execute_effects컴? commit + prints + exit code  (IO, edge)
#
